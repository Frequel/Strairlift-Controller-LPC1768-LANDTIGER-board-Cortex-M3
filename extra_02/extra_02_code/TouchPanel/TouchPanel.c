...
* Description    : computation of A B C D E F
* Input          : None
* Output         : None
...
void draw_power(){
	LCD_DrawLine(185,45,196,45,0xffff);
	LCD_DrawLine(204,45,215,45,0xffff);
	LCD_DrawLine(185,45,185,75,0xffff);
	LCD_DrawLine(215,45,215,75,0xffff);
	LCD_DrawLine(185,75,215,75,0xffff);
	LCD_DrawLine(200,30,200,60,0xffff);
}
/*********************************************************************************************************
      END FILE
*********************************************************************************************************/
