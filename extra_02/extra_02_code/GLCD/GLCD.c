...
//x60x240y60y160
void LCD_ClearSection(uint32_t x1,uint32_t y1,uint32_t x2,uint32_t y2,uint16_t Color){
	uint32_t index;
	
	//tante draw line riga per riga orizzontale
	for( index = 0; index < x2; index++ ){
		LCD_DrawLine(x1+index,y1,x1+index,y2, Color);
	}
